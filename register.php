                        ...
                        <form action="functions\authcode.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div style="display:flex">
                                    <div style="width: 20%;">
                                        <select name="countryCode" class="form-control" id="Ccode">
                                    ...
                                    <div style="width:80%"><input type="phone" name="phone" class="form-control" placeholder="Enter your phone number"></div>
